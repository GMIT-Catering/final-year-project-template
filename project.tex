...
%% Change these:
\newcommand{\projecttitle}{Food Ordering System for the GMIT Catering Company}
\newcommand{\projectauthor}{Ronan Connolly \\[0.2cm] Vladislav Marisevs}
...
\begin{document}
  ...
  %\bibliographystyle{ieeetr}
   ...
   \bibliography{bibliography,mobileapp}
\end{document}
