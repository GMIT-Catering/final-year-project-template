...
\end{wrapfigure} 
  ...
  \begin{figure}[H] 
  	\center{\includegraphics[width=0.75\linewidth]{img/issue_tracker}}
  ...
  \begin{figure}[H] 
  	\center{\includegraphics[width=0.75\linewidth]{img/github_org}}
...
~\cite{PDF_Make_module}
  ...
  \section{Mobile App}
% Screen shots of all the sections in the application

% comment on each feature and use case
...
% talk about the project as a whole, what we learnt, what we would do differently, what we gained, high level stuff, last line should be quotable, maybe quote somebody
