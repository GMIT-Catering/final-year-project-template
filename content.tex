...
The push server uses the MEAN Stack, Yeoman scaffolds  the project which uses NodeJS as the environment, Express as the Web Framework and Angular as the MVC (Model View Controller) framework in order to build the web application.
\linebreak
...
\item We felt there was no big disadvantage on having the push server seperate
...
\begin{itemize}
	...
	\item We used GitHub during the development process, tracking tasks via the  Issue tracker.
...
\\
www/app/app.js
\begin{minted}[breaklines, mathescape, numbersep=5pt, numbersep=5pt, xleftmargin=0pt]{css}
.constant('SERVER', {
  // test server
...
%If team based, did you use  during the development process.
...
\begin{minted}[breaklines, mathescape,, numbersep=5pt, numbersep=5pt, xleftmargin=0pt]{bash}
> heroku login
> git init
> heroku create
> git add .
...
\begin{minted}[breaklines, mathescape,, numbersep=5pt, numbersep=5pt, xleftmargin=0pt]{yaml}
web: node server.js
\end{minted}
...
\end{minted}
  ...
  \begin{wrapfigure}{r}{2.5cm}
  	\includegraphics[width=3cm]{img/mobile-app/logos/json.jpg}
  \end{wrapfigure} 
...
Both setting up and querying a RESTful system is trivial.
  ...
  \begin{wrapfigure}{r}{2.5cm}
  	\includegraphics[width=3cm]{img/mobile-app/logos/http.png}
  \end{wrapfigure} 
  \cite{http_methods}
...
Here is a diagram of our system design/architecture:

  \begin{figure}[H] 
      \center{\includegraphics[width=1.0\linewidth]{img/ZF2/ionic_zf2_mysql_diagram.png}}
...
\chapter{System Evaluation}	% n-m pages
  \begin{figure}[H] 
      \center{\includegraphics[width=1.0\linewidth]{img/system_design.jpg}}
...
\pagebreak
%what we gained
We learned much in this project, more then in any other project before.
